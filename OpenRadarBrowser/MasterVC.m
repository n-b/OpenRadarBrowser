...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ((DetailVC*)segue.destinationViewController).radar = [self.frc objectAtIndexPath:self.tableView.indexPathForSelectedRow];
    }
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    Radar * radar = [self.frc objectAtIndexPath:indexPath];
    cell.textLabel.text = radar.title;
    cell.detailTextLabel.text = radar.number;
}
...
- (NSFetchedResultsController *)frc
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Radar" inManagedObjectContext:self.moc];
